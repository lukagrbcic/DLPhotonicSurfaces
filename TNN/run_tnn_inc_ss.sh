...
python main.py standard stainless_steel 
...
### for inconel task
### forward DNN hot starting from scratch
### inverse DNN hot started on SS
python main.py transfer_learning inconel inconel --inverse_DNN_dataset_hot_start stainless_steel \
...
python main.py transfer_learning inconel inconel True --forward_DNN_hot_start_dataset stainless_steel \
    --inverse_DNN_dataset_hot_start stainless_steel --mode train --num_inverse_layers_to_transfer 1
