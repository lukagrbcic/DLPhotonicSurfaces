...
# python main.py standard stainless_steel stainless_steel False --mode train
...
# python main.py transfer_learning inconel inconel False --inverse_DNN_hot_start_dataset stainless_steel \
...
# python main.py transfer_learning stainless_steel stainless_steel False --inverse_DNN_hot_start_dataset inconel \
#     -- mode train ==num_inverse_layers_to_transfer 1

# ### for ss task
# ### forward DNN hot started on inconel
# ### inverse DNN hot started on inconel
# python main.py transfer_learning stainless_steel stainless_steel --forward_DNN_hot_start_dataset inconel \
