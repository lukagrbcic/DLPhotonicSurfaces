...
def main():
    ...
    if args.mode == 'train':
        ...
        outfile = f'{result_dir}/{args.configuration}_{args.dataset_name}_dataset_forwardDNN_{forward_transfer_descriptor}_{forward_hot_start}_inverseDNN_{inverse_hot_start}.json'
