...
python train_forward.py inconel transfer_learning configs/forward/forward.yaml --hot_start_model_path forwardDNN/stainless_steel_forward_DNN.pth --num_layers_to_transfer 1

### STAINLESS STEEL TASK WITH INCONEL HOT START
python train_forward.py stainless_steel transfer_learning configs/forward/forward.yaml --hot_start_model_path forwardDNN/inconel_forward_DNN.pth --num_layers_to_transfer 1
